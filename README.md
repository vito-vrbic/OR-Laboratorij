...
This repository contains an open dataset of music albums and songs. The data included in this dataset is factual information about albums (album title, artists, producers, release year, genre, style, number of singles, record label, country of release, type, songs), as well as factual information about songs (title, track number on the album, duration) within each album.
